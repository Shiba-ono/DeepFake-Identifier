...
Technical Stack
ComponentDetailFrameworkPyTorchModelEfficientNet-B0 (pretrained on ImageNet)OptimiserAdamW with weight decay 1e-4SchedulerCosine Annealing LREvaluationAUC-ROC + AccuracyTrainingMixed precision (torch.cuda.amp)HardwareNVIDIA GPU (4GB VRAM)

Dataset
140k Real and Fake Faces — Kaggle
https://www.kaggle.com/datasets/xhlulu/140k-real-and-fake-faces

70k real faces sourced from the Flickr-Faces-HQ (FFHQ) dataset
70k fake faces generated using StyleGAN by NVIDIA
...
Random JPEG compression (quality=50–95) — added to improve robustness across image quality levels
